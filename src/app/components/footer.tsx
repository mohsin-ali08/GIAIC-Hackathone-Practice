...
import {
  faArrowCircleRight,
  faCopyright,
} from "@fortawesome/free-solid-svg-icons"; // Social icons
  ...
  return (
    <main className="bg-neutral-900">
            ...
            <ul>
              ...
              <li className="mt-3 cursor-pointer py-1 border flex justify-center items-center">
                ...
                <FontAwesomeIcon
                  ...
                  className="text-xl ml-2 sm:hidden md:block" // Show icon only on medium screens and up
                />
              </li>
            </ul>
          </div>
      ...
      <p className="text-white text-center text-sm pb-4">
        ...
        ></FontAwesomeIcon>
        Copyright Rimel 2022. All right reserved <span>_MOHSIN ALi</span>{" "}
      </p>
    </main>
  );
}
